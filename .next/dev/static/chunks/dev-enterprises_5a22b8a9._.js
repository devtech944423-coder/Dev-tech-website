...
async function getAllCategories() {
    try {
        console.log(`Auto-detecting categories from ${__TURBOPACK__imported__module__$5b$project$5d2f$dev$2d$enterprises$2f$lib$2f$firebase$2f$categories$2d$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["collectionNamesToCheck"].length} potential collections...`);
        const detectedCategories = [];
        // Check each collection name to see if it exists and has documents
        for(let i = 0; i < __TURBOPACK__imported__module__$5b$project$5d2f$dev$2d$enterprises$2f$lib$2f$firebase$2f$categories$2d$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["collectionNamesToCheck"].length; i++){
            const collectionName = __TURBOPACK__imported__module__$5b$project$5d2f$dev$2d$enterprises$2f$lib$2f$firebase$2f$categories$2d$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["collectionNamesToCheck"][i];
            try {
                    ...
                    try {
                        ...
                        console.log('Products fetched:', {
                            ...
                            products: fetchedProducts.map({
                                "Products.useEffect.fetchProducts": (p)=>({
                                        id: p.id,
                                        name: p.name
                                    })
...
//# sourceMappingURL=dev-enterprises_5a22b8a9._.js.map