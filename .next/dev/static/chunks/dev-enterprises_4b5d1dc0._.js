...
async function getAllProducts() {
    try {
        const productsRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$dev$2d$enterprises$2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["collection"])(__TURBOPACK__imported__module__$5b$project$5d2f$dev$2d$enterprises$2f$lib$2f$firebase$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"], 'products');
        // Try with orderBy first (if rules allow it)
        try {
            ...
            // If orderBy fails (e.g., due to missing index or rules), try without it
            if (orderByError?.code === 'failed-precondition') {
                ...
                try {
                    ...
                    // If fallback also fails, check if it's a permission error
                    if (isPermissionError(fallbackError)) {
                        // Permission denied - return empty array gracefully
                        return [];
                    }
                    throw fallbackError;
                }
            } else if (isPermissionError(orderByError)) {
                // Permission error on orderBy - try simple query
                try {
                    const querySnapshot = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$dev$2d$enterprises$2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDocs"])(productsRef);
                    const products = [];
                    querySnapshot.forEach((doc)=>{
                    ...
                    // If fallback also fails with permission error, return empty array
                    if (isPermissionError(fallbackError)) {
                        // Permission denied - return empty array gracefully
                        return [];
                    }
...
async function getProductsByCategory(categoryId, categoryCollectionName) {
    try {
        ...
        try {
            ...
            console.log(`Fetched ${products.length} products from ${collectionName}`);
            return products;
        } catch (orderByError) {
...
async function getAllCategories() {
    try {
        ...
        console.log(`Loaded ${categories.length} categories from configuration:`, categories.map((c)=>c.name));
        // Verify collections exist by attempting to access each
        // This helps catch errors early, but we'll still show categories even if verification fails
        const verifiedCategories = [];
        for (const category of categories){
            if (category.collectionName) {
                try {
                    // Try to access the collection (just check if we can read it)
                    const testRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$dev$2d$enterprises$2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["collection"])(__TURBOPACK__imported__module__$5b$project$5d2f$dev$2d$enterprises$2f$lib$2f$firebase$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"], category.collectionName);
                    const testQuery = (0, __TURBOPACK__imported__module__$5b$project$5d2f$dev$2d$enterprises$2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["query"])(testRef);
                    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$dev$2d$enterprises$2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDocs"])(testQuery);
                    verifiedCategories.push(category);
                    console.log(`✓ Verified collection: ${category.collectionName}`);
                } catch (error) {
                    if (isPermissionError(error)) {
                        console.warn(`⚠ Permission denied for collection: ${category.collectionName}. Category will still be shown.`);
                    } else {
                        console.warn(`⚠ Could not verify collection: ${category.collectionName}. Error:`, error.message);
                    }
                    // Still add it - might work when actually fetching products
                    verifiedCategories.push(category);
                }
            } else {
                // Category without collectionName - skip it
                console.warn(`⚠ Category "${category.name}" missing collectionName field`);
            }
        }
        return verifiedCategories;
    } catch (error) {
        console.error('Error loading categories from configuration:', error);
        return [];
    }
}
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
...
function Products() {
    ...
    const [products, setProducts] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$dev$2d$enterprises$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
                ...
                "Products.useEffect.handleHashChange": ()=>{
                    ...
                    if (hash) {
                        ...
                        const categoryExists = categories.some({
                            "Products.useEffect.handleHashChange.categoryExists": (cat)=>cat.id === hash
                        }["Products.useEffect.handleHashChange.categoryExists"]);
                        if (categoryExists) {
            ...
            const fetchCategories = {
                "Products.useEffect.fetchCategories": async ()=>{
                    ...
                    try {
                        ...
                        console.log('Categories fetched:', fetchedCategories.length, fetchedCategories);
                ...
                "Products.useEffect.fetchProducts": async ()=>{
                    ...
                    try {
                        ...
                        const category = categories.find({
                            "Products.useEffect.fetchProducts.category": (cat)=>cat.id === selectedCategory
                        }["Products.useEffect.fetchProducts.category"]);
                        const collectionName = category?.collectionName;
                        const fetchedProducts = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$dev$2d$enterprises$2f$lib$2f$firebase$2f$products$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getProductsByCategory"])(selectedCategory, collectionName);
                                            ...
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$dev$2d$enterprises$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("ol", {
                                                    ...
                                                    children: [
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$dev$2d$enterprises$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("li", {
                                                            children: [
                                                                'For each collection (like "Electronics", "Sweets"), add an entry with:',
                                                                    ...
                                                                    children: [
                                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$dev$2d$enterprises$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("li", {
                                                                            children: [
                                                                                ...
                                                                                ": your Firestore collection name (must match exactly)"
                                                                            ]
                                                                        }, void 0, true, {
                                                                            fileName: "[project]/dev-enterprises/app/products/page.tsx",
                                                                            lineNumber: 217,
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$dev$2d$enterprises$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                    ...
                                                    children: "Check browser console (F12) for detailed error messages"
                                                }, void 0, false, {
                                                    fileName: "[project]/dev-enterprises/app/products/page.tsx",
                                                    lineNumber: 223,
                                                    columnNumber: 19
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$dev$2d$enterprises$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
                        ...
                        children: [
                            ...
                            loading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$dev$2d$enterprises$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                lineNumber: 259,
                                columnNumber: 13
                            }, this) : products.length > 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$dev$2d$enterprises$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(Products, "mt5iTKyJf+n9KaPvcUQ8d3HtgRw=");
_c = Products;
var _c;
...
//# sourceMappingURL=dev-enterprises_4b5d1dc0._.js.map