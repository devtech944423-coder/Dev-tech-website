 ...
 */ async function getCategoriesFromFirestore() {
    ...
    try {
            ...
            try {
                ...
                if (!hasExplicitCollectionName) {
                    if (doc.id !== finalCategoryName) {
                        console.log(`   ℹ️ Using document ID "${doc.id}" as collection name (differs from category name "${finalCategoryName}")`);
                    } else {
        ...
        if (categories.length > 0) {
            console.log(`\n🔍 Validating ${categories.length} categories - checking if collections exist and have products...`);
            ...
            if (invalidCategories.length > 0) {
                console.log(`\n⚠️ Filtered out ${invalidCategories.length} category/categories with empty or non-existent collections:`);
                invalidCategories.forEach((invalid)=>{
                    console.log(`   - "${invalid.name}" (collection: "${invalid.collectionName}") - ${invalid.reason}`);
                });
                console.log(`   💡 To remove these categories, delete the corresponding documents from _categories collection in Firestore`);
            }
            if (validatedCategories.length > 0) {
                console.log(`\n✅ Successfully validated ${validatedCategories.length} categories with products:`, validatedCategories.map((c)=>`${c.name} (id: ${c.id})`));
                return validatedCategories;
            } else {
                console.warn(`⚠️ All categories were filtered out - no collections exist or have products`);
                return [];
            }
        }
 ...
 */ async function validateCategoryCollection(collectionName) {
    try {
        ...
        if (isPermissionError(error)) {
            console.log(`   🔍 Collection "${collectionName}" - permission denied (may not exist)`);
        } else {
            console.log(`   🔍 Collection "${collectionName}" does not exist or is inaccessible`);
        }
        return false;
    }
}
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$dev$2d$enterprises$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Products.useEffect": ()=>{
            const fetchCategories = {
                "Products.useEffect.fetchCategories": async ()=>{
            ...
            }["Products.useEffect.fetchCategories"];
            fetchCategories();
        }
    }["Products.useEffect"], []);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$dev$2d$enterprises$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Products.useEffect": ()=>{
            ...
            const fetchAllProducts = {
                "Products.useEffect.fetchAllProducts": async ()=>{
                    setLoading(true);
                    setError(null);
                    try {
                        ...
                        const fetchedProducts = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$dev$2d$enterprises$2f$lib$2f$firebase$2f$products$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getAllProducts"])();
                        console.log('✅ All products fetched:', {
                            totalCount: fetchedProducts.length,
                            productsByCategory: categories.map({
                                "Products.useEffect.fetchAllProducts": (cat)=>{
                                    const count = fetchedProducts.filter({
                                        "Products.useEffect.fetchAllProducts": (p)=>{
                                    ...
                                    }["Products.useEffect.fetchAllProducts"]).length;
                                    return {
                                        category: cat.name,
                                        count
                                    };
                                }
                            }["Products.useEffect.fetchAllProducts"])
                        });
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$dev$2d$enterprises$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$dev$2d$enterprises$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("ol", {
                                                    className: "text-gray-600 text-sm space-y-2 list-decimal list-inside",
                                                    children: [
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$dev$2d$enterprises$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("li", {
                                                            children: [
                                                                "Open ",
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$dev$2d$enterprises$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("code", {
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$dev$2d$enterprises$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("li", {
                                                            children: [
                                                                ...
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$dev$2d$enterprises$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("ul", {
...
_s(Products, "ZfTAAuFUeOr2etaJCpf9iNJmwIE=");
_c = Products;
var _c;
...
//# sourceMappingURL=dev-enterprises_4e05014d._.js.map